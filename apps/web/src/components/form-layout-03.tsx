            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-6">
              ...
              <div className="col-span-full sm:col-span-3">
                <Field className="gap-2">
                  ...
                  <Input type="number" id="birthyear" name="year" placeholder="1990" />
                </Field>
              </div>
              <div className="col-span-full sm:col-span-3">
                <Field className="gap-2">
                  <FieldLabel htmlFor="role">Role</FieldLabel>
                  <Input type="text" id="role" name="role" placeholder="Senior Manager" disabled />
                  <FieldDescription>Roles can only be changed by system admin.</FieldDescription>
                </Field>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-6">
              ...
              <div className="col-span-full">
                <Field className="gap-2">
                  ...
                  <Textarea id="workspace-description" name="workspace-description" rows={4} />
                  <FieldDescription>
            ...
            <fieldset>
              ...
              <div className="mt-2">
                ...
                <div className="flex items-center gap-x-3 py-1">
                  ...
                  <FieldLabel htmlFor="team-activity-digest" className="font-normal">
            ...
            <fieldset className="mt-6">
              ...
              <div className="mt-2">
                ...
                <div className="flex items-center gap-x-3 py-1">
                  ...
                  <FieldLabel htmlFor="workspace-execution" className="font-normal">
