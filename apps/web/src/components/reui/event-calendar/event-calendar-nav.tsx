...
import { ArrowDown01Icon, ArrowLeft01Icon, ArrowRight01Icon, Calendar03Icon } from "hugeicons-react"
      ...
      >
        ...
        >
          {children ?? (
            <>
              {viewLabel(view)}
              <ArrowDown01Icon className="size-4 opacity-60" aria-hidden="true" />
            </>
          )}
        </DropdownMenuTrigger>
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <NavTooltip content={tooltip}>
        ...
        >
          {children ?? (
            <Calendar03Icon className="size-4" aria-hidden="true" />
          )}
        </PopoverTrigger>
      </NavTooltip>
      <PopoverContent
